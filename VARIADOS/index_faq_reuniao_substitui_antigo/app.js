...
// =============================================================
// FAQ (interativo) — Modal
// =============================================================
function openFaqModal() {
  const modal = document.getElementById("faqModal");
  const iframe = document.getElementById("faqFrame");
...
function setupFaqModal() {
  ...
  const btnClose = modal.querySelector("[data-faq-close]");
  const btnNewTab = modal.querySelector("[data-faq-newtab]");
  const iframe = document.getElementById("faqFrame");

  btnClose && btnClose.addEventListener("click", closeFaqModal);
  ...
  btnNewTab && btnNewTab.addEventListener("click", () => {
...
function setupOpenFaqButtons() {
  ...
  btns.forEach((btn) => btn.addEventListener("click", openFaqModal));
}
